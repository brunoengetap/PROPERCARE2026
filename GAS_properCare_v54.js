...
function _marcarMaquinaAtendidaOS_(idOs, machineKeyVal, visitId) {
  ...
  // Sem vínculo prévio em OS_MAQUINAS para essa máquina — não é esperado no fluxo normal
  // (a máquina deveria já estar vinculada à OS antes de a preventiva ser aberta a partir dela),
  // mas não lançamos erro aqui: quem chama já está em try/catch não-bloqueante.
  Logger.log('_marcarMaquinaAtendidaOS_: nenhum vínculo OS_MAQUINAS encontrado para id_os=' + idOs + ' machineKey=' + machineKeyVal);
}
